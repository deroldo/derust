...
impl SystemUiOverlayStyle {
    ...
    pub fn with_system_navigation_bar_divider_color(
        mut self,
        system_navigation_bar_divider_color: Color,
    ) -> Self {
        self.system_navigation_bar_divider_color = Some(system_navigation_bar_divider_color.hex);
        self
    }

    pub fn with_system_navigation_bar_icon_brightness(
        mut self,
        system_navigation_bar_icon_brightness: Brightness,
    ) -> Self {
        self.system_navigation_bar_icon_brightness = Some(system_navigation_bar_icon_brightness);
        self
    }

    pub fn with_system_navigation_bar_contrast_enforced(
        mut self,
        system_navigation_bar_contrast_enforced: bool,
    ) -> Self {
        self.system_navigation_bar_contrast_enforced =
            Some(system_navigation_bar_contrast_enforced);
        self
    }
    ...
    pub fn with_status_bar_icon_brightness(
        mut self,
        status_bar_icon_brightness: Brightness,
    ) -> Self {
        self.status_bar_icon_brightness = Some(status_bar_icon_brightness);
        self
    }

    pub fn with_system_status_bar_contrast_enforced(
        mut self,
